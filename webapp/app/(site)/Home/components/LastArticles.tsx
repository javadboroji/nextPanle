        ...
        <Link href={`/article/${detail.id}`}>
            <div className='flex  flex-col w-full h-full shadow-2xl p-4 rounded-2xl'>
                <div className='flex justify-between p-2'>
                    ...
                    <span className='flex items-center  text-xs p-1 text-gray-400'><HiOutlineCalendarDateRange size={20} className='ml-1' /> {detail.date}</span>
                ...
                <span className='text-gray-500 text-xs     line-clamp-2'>{detail.summary}</span>
            </div>
        </Link>
